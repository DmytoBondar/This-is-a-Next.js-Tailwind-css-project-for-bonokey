    ...
    return (
      <div>
        ...
        <main>
          ...
          <h2>Compare best loan, credit card, and deposite from Saudi banks</h2>
          ...
          <div className={styles.grid}>
            ...
            >
              ...
              <p>
                Compare all credit cards and visa and get the most suite your
                needs!
              </p>
            </a>
            ...
            >
              <h3>Deposit &rarr;</h3>
              <p>Want to invest your cash, find the best deposit rare!</p>
            </a>
          </div>
        </main>
