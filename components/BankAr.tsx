      ...
      <div className={styles.bank}>
        ...
        <div className={styles.info}>
          ...
          <div className={styles.apr}>
            <h6>
              <span>ثابتة</span> {this.state.apr.toFixed(2)}%{" "}
              <span className={styles.type}>APR</span>
            </h6>
          ...
          <div className={styles.text}>
            <h6>
              ...
              <span style={{ fontSize: 13 }}>ر.س</span>
            </h6>
            <p>
              {this.props.useMaxLoan ? "الحد الاعلى للتمويل" : "مبلغ التمويل"}
            </p>
          </div>
        ...
        <div className={styles.details}>
          {!this.state.showDetails ? (
            <p className={styles.text}>
              ...
              العمل ومدة استحقاق التمويل المختلفة وقد تتأثر بالسجل الائتماني
              الخاص لكل عميل
            </p>
          ) : (
            ...
            >
              ...
              >
                {!this.state.userMobileVerified ? (
                  <div>
                    <p>
                      لتتمكن من التواصل مع ممثل البنك الرجاء تاكيد رقم الجوال
                    </p>
                    <div style={{ marginTop: "36px" }}>
                      {!this.state.userConfirmationResult ? (
                              ...
                              try {
                                ...
                                return signInWithPhoneNumber(
                                  ...
                                  .catch((error) => {
                                    ...
                                    toast.dismiss();
                                    toast.error(
                                      "حصل خطأ الرجاء المحاولة من جديد"
                                    );
                                  });
                              } catch (error) {
                                console.log(
                        ...
                        <div style={{ marginTop: "24px" }}>
                          <div className={styles.inputContainer}>
                            <label htmlFor="userVerificationCode">
                              رمز التحقق
                            </label>
                            <input
                          ...
                          <button
                            ...
                            disabled={
                              !(
                                this.state.userMobileVerificationCode.length >=
                                6
                              )
                            }
                            style={{ marginTop: "12px" }}
