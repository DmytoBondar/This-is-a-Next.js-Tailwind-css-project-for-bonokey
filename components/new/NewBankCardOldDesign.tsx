...
import ChatPanel from "./ChatPanelAr";
import { expenseObjectType } from "./ChatPanelAr";
...
function NewBankCardOldDesign(props: Props) {
  ...
  useEffect(() => {}, [verifyCodeAndSendWhatsApp]);
    ...
    <div className={styles.bank}>
      ...
      <div className={styles.info}>
        ...
        <div className={styles.text}>
          ...
          <p>
            {props.bank.useMaxLoan ? "الحد الأعلى للتمويل" : "مبلغ التمويل"}
          </p>
        </div>
          ...
          <button
            ...
            onClick={() => {
              ...
              if (chatPanelRef.current) {
                // @ts-ignore
                const topOffset = chatPanelRef.current.offsetTop; // Subtract header height from top offset
              ...
              <div style={{ marginTop: "24px" }}>
                {!phoneNumberConfirmationResult ? (
                  ...
                  <div style={{ marginTop: "24px" }}>
                    ...
                    {isCounting && (
                      <div style={{ marginTop: "10px" }}>{countDown}</div>
                    )}
                    <PromptButton
                      style={{ marginTop: "8px" }}
                      onClick={async (e) => {
      ...
      <div ref={chatPanelRef}>
        {showChatPanel && (
          <ChatPanel
            apr={props.bank.apr.toFixed(2)}
            loanAmount={props.bank.loan.toFixed(0)}
            salaryAmount={props.bank.userMonthlySalary}
            durationYear={props.bank.loanDurationInYears}
            expenseAutoFill={props.expenseAutoFill}
