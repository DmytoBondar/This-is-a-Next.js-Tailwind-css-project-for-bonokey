      ...
      <ContentContainerDiv data-aos="fade-up" data-aos-delay="600">
        ...
        <GridDiv>
          <HighlightDiv>
            ...
            <Caption>
              Easily find and compare the best product that fits your needs and
              learn its benefits and features.
            </Caption>
          </HighlightDiv>
          <HighlightDiv>
            <FaTrophy
            ...
            <Caption>
              Lowest APR rate and financial products offers that are exclusive
              only on Bonokey and match your profile.
            </Caption>
          </HighlightDiv>
          <HighlightDiv>
            <FaPhoneVolume
            ...
            <Caption>
              You need to speak to expert to help you understand and help you in
              your financial needs? We get you covered.
            </Caption>
          </HighlightDiv>
        </GridDiv>
      </ContentContainerDiv>
