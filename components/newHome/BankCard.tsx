      ...
      <CardDiv data-aos="fade-up" data-aos-delay={`${props.index}0`}>
        <MainContentDiv>
          <MainGridDiv style={{ alignItems: "center" }}>
            <BankNameDiv>
              <Img style={{ width: "80px" }} src={props.bank.logo} alt="bank logo" />
              <BankName>{props.bank.name}</BankName>
            </BankNameDiv>
            <KPIDiv>
              <div style={{ textAlign: "center" }}>
                <KPIValue>
                  {props.bank.loan.toLocaleString(undefined)} SAR
                </KPIValue>
                <KPIName>Loan amount</KPIName>
              </div>
              <div style={{ textAlign: "center" }}>
                <KPIValue>
                  {props.bank.monthly.toLocaleString(undefined)} SAR
                </KPIValue>
                <KPIName>Monthly</KPIName>
              </div>
              <div style={{ textAlign: "center" }}>
                <KPIValue>
                  {props.bank.total.toLocaleString(undefined)} SAR
                </KPIValue>
            ...
            <ContactDiv>
              <PercentageText>
                {props.bank.apr.toLocaleString(undefined, {
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr" }}>
            ...
            <div>
              <DetailText style={{ textAlign: "center" }}>
                ...
                and term. It may be affected by each clients credit scroing.
              </DetailText>
            </div>
            ...
            >
              <div style={{ textAlign: "left" }}>
                ...
                <ul style={{ listStyle: "inside", marginTop: "12px" }}>
                  <DetailLi style={{ marginBottom: "6px" }}>
                    Shariah compliant.
                  </DetailLi>
                  <DetailLi style={{ marginBottom: "6px" }}>
                    Instant approval.
                  ...
                  <DetailLi style={{ marginBottom: "6px" }}>
                    Repayment periods from 3 months up to 12 months.
                  </DetailLi>
                  <DetailLi style={{ marginBottom: "6px" }}>
              ...
              <DetailMoneyGridDiv>
                <div style={{ textAlign: "center" }}>
                  ...
                  <DetailText>
                    {props.bank.fees.toLocaleString(undefined)} SAR
                  </DetailText>
                </div>
                <div style={{ textAlign: "center" }}>
                  <FaMoneyBillWave color={brandColors.moneyGreen} size={25} />
                  ...
                  <DetailText>
                    {props.bank.maxLoan.toLocaleString(undefined)} SAR
                  </DetailText>
                </div>
                <div style={{ textAlign: "center" }}>
                  <FaMoneyBillWave color={brandColors.moneyGreen} size={25} />
                  ...
                  <DetailText>
                    {props.bank.salaryTransfer ? "YES" : "NO"}
                  </DetailText>
                </div>
                <div style={{ textAlign: "center" }}>
                  <FaMoneyBillWave color={brandColors.moneyGreen} size={25} />
                  ...
                  <DetailText>
                    {props.bank.revenue.toLocaleString(undefined)} SAR
                  </DetailText>
                </div>
                <div style={{ textAlign: "center" }}>
                  <FaMoneyBillWave color={brandColors.moneyGreen} size={25} />
                  ...
                  <DetailText>
                    {props.bank.minLoan.toLocaleString(undefined)} SAR
                  </DetailText>
                </div>
              </DetailMoneyGridDiv>
            </DetailGridDiv>
