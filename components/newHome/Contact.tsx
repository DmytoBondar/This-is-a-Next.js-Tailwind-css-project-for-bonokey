    ...
    <ContentContainerDiv>
      <ContactDiv data-aos="fade-up">
        <div style={{ maxWidth: "500px", margin: "0 auto" }}>
          ...
          <Caption>
            We offer you free consultations with a finance expert and consultant
            who will answer all your questions and assist you in the personal
            financial planning process.
          </Caption>

          <Link href="http://blog.bonokey.com/en/#contact" passHref>
            <ContactButton style={{ marginTop: "24px" }}>Join Us</ContactButton>
          </Link>
        </div>
      </ContactDiv>
    </ContentContainerDiv>
